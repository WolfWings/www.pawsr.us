...
// { prelogin_twitter: 'NJ7lOxiJ8G9tTGz6u3jLHl76fm2y362x',
//   twitter_token_secret: 'GFVJg6p7g0rr1lPzFjIgUGnYGiGNMeze',
//   twitter_token: 'z9oWdAAAAAAAuUkVAAABVxAfgwE' }

try {
	if (data.query.state !== data.session.prelogin_twitter) {
...
keyvalue.set('twitter_login_' + data.session.prelogin_twitter, 'wip');
